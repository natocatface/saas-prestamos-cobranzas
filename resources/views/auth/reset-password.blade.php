...
<div style="min-height:100vh;display:grid;place-items:center;padding:24px;background:var(--content-bg)">
    <div class="login-card" style="background:#fff;border:1px solid var(--border);border-radius:16px;padding:34px;box-shadow:var(--shadow-md);max-width:420px;width:100%">
        <div class="brand-mobile" style="display:flex;flex-direction:column;align-items:center;margin-bottom:18px">
            ...
            <strong style="font-size:18px">Nueva contraseña</strong>
        </div>

        <h2 style="font-size:22px;font-weight:800;margin-bottom:4px">Restablecer contraseña</h2>
        <p class="muted" style="margin-bottom:22px">Define una nueva contraseña para tu cuenta.</p>
        ...
        <form action="{{ route('password.update') }}" method="POST">
            ...
            <button type="submit" class="btn btn-primary" style="width:100%;justify-content:center;padding:12px"><i class="bi bi-check-lg"></i> Restablecer contraseña</button>
        </form>
